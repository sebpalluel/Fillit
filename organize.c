...
static size_t	tet_min_xy(t_list **tet, int *array, size_t xy)
{
	size_t		i;
...
static size_t	tet_max_xy(t_list **tet, int *array, size_t xy)
{
	size_t		i;
...
static void		mv_upleft(t_list **tet, size_t min[2])
{
	size_t		i;
